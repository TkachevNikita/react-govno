  ...
  return (
        <Dialog open={isOpen} onClose={handleClose}>
            ...
            <DialogContent>
                <DialogContentText>
                    <form className="form">
                        <TextField variant="outlined" type="text" onChange={(e) => setName(e.target.value)} placeholder='Введите ФИО'/>
                        <TextField variant="outlined" type="email" onChange={(e) => setEmail(e.target.value)} placeholder='Введите email'/>
                            <TextField
